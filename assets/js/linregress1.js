...
function compute_error(){
    ...
    ul_s = slope("#user_line_segment");
    ul_b = d3.select("#user_line_segment").attr("y1");
    y_axis_length = 10;
...
var lineDrag = d3.drag()
    ...
    .on('drag', function(d){
        ...
        var y = d3.event.y;
        var dy = d3.event.dy;
        var x1 = parseFloat(d3.select("#user_line_segment").attr('x1'));
        var y1New = parseFloat(d3.select("#user_line_segment").attr('y1'))+ dy;
        var x2 = parseFloat(d3.select("#user_line_segment").attr('x2'));
        var y2New = parseFloat(d3.select("#user_line_segment").attr('y2'))+ dy;
        ...
        var ul_x1 = parseFloat(d3.select("#user_line").attr('x1'));
        var ul_y1 = parseFloat(d3.select("#user_line").attr('y1'))+ dy;
        var ul_x2 = parseFloat(d3.select("#user_line").attr('x2'));
        var ul_y2 = parseFloat(d3.select("#user_line").attr('y2'))+ dy;
        userLine
            .attr("x1", ul_x1)
            .attr("y1", ul_y1)
            .attr("x2", ul_x2)
...
var lineRotate = d3.drag()
    ...
    .on('drag', function(d){
        ...
        var ul_y1 = y-(x-ul_x1)*slope("#user_line_segment");
        var ul_x2 = width;
        var ul_y2 = y-(x-ul_x2)*slope("#user_line_segment");
        userLine
            .attr("x1", ul_x1)
            .attr("y1", ul_y1)
            .attr("x2", ul_x2)
...
var userSSEText = svg.append("text")
...
var userRMSEText = svg.append("text")
  .attr("class", "user_information_title")
  .text("RMSE: ")
